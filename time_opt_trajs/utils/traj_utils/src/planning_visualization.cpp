...
namespace opt_planner
{
  ...
  void PlanningVisualization::displayPolyhedron(visualization_msgs::Marker component, Eigen::Vector4d color, int id){
    ...
    component.id = id;
    component.color.r = color(0);
    component.color.g = color(1);
    component.color.b = color(2);
    component.color.a = color(3);
  ...
  void PlanningVisualization::display2DMarkerList(ros::Publisher &pub, const vector<Eigen::Vector2d> &list, double scale,
  ...
  void PlanningVisualization::displayGlobalPathList(vector<Eigen::Vector3d> global_pts, const double scale, int id)
  {
    ...
    displayMarkerList(global_list_pub, global_pts, scale, color, id);
  }
